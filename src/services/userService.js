...
const userService = {
   ...
   */
  loginUser: userData => {
    // return axios.get('https://api.block.com/user', userData).then(response => response.data);
    // return fetch('https://api.block.com/user', userData).then(response => response.json());
